(function ($) {
  ...
  if ($(".circle-main").length) {
    ...
    text_1.innerHTML = text_1.innerHTML
      .split("")
      .map(
        (char, i) =>
  ...
  if ($(".main-header li.dropdown ul").length) {
    $(".main-header .navigation li.dropdown").append(
      '<div class="dropdown-btn"><i class="icon-07"></i></div>'
    );
  }
  ...
  if (e) {
    ...
    console.error("Element with ID 'mouse-pointer' not found.");
}
//   document
